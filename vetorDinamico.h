 ...
 */
int array_list_get(array_list * list, int index, int *error);
 ...
 * \return unsigned int 
 */
unsigned int array_list_push_back(array_list * list, int i);
 ...
 */
unsigned int array_list_pop_back(array_list * list);
 ...
 */
int array_list_find(array_list * list, int element);
 ...
 * \todo Implement function.
 */
unsigned int array_list_insert_at(array_list * list, int index, int value);
 ...
 * \todo Implement function.
 */
unsigned int array_list_remove_from(array_list * list, int index);
 ...
 */
unsigned int array_list_capacity(array_list * list);


/**
 * \brief Check the array_list 'list' occupation, in percent.
 * 
 * \param list The 'list' to be checked.
 * \return double A number between 0.0 and 1.0, representing the 
 * total space used as a percent from the reserved space. 
 */
double array_list_percent_occupied(array_list * list); 
