 ...
 */
int linked_list_get(linked_list * list, int index, int *error);
 ...
 * \return unsigned int 
 */
unsigned int linked_list_push_back(linked_list * list, int i);
 ...
 */
unsigned int linked_list_pop_back(linked_list * list);
 ...
 */
int linked_list_find(linked_list * list, int element);
 ...
 * \todo Implement function.
 */
unsigned int linked_list_insert_at(linked_list * list, int index, int value);
 ...
 * \todo Implement function.
 */
unsigned int linked_list_remove_from(linked_list * list, int index);
